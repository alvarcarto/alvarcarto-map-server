...
# * $ALVAR_MAP_SERVER_DATA_DIR must have at least 350GB free disk space
# *

# Warning: running this will download ~40GB of data from internet,
#          over 300GB of disk space and a lot of server resources will be used
...
# Postgis data etc.
# This directory needs to be in a volume which has at least 350GB free disk space
